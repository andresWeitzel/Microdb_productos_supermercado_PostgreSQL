# Microdb_productos_supermercado_PostgreSQL
...
![Index app](https://github.com/andresWeitzel/Microdb_productos_supermercado_PostgreSQL/blob/master/documentation/microdb_productos_supermercado_DER.png)
...
#### Listado de usuarios de la Tabla  `usuarios` 
...
### Paso 1) Configuración y Puesta en Marcha de la Base de Datos `microdb_productos_supermercado`
...
#### 1.4) Creación de la Base de Datos `microdb_productos_supermercado` en la Conexión de PostgreSQL
...
*  Click Der sobre la conexión creada `postgres`
    * --> Crear, Base de Datos
    * --> En Database Name colocamos `microdb_productos_supermercado`.
...
#### 1.5) Creación de una Conexión Independiente de la Base de Datos `microdb_productos_supermercado`
...
* Click sobre la Pestaña Archivo.
    ...
    * --> Database Connection, Siguiente.
    * --> Seleccionar el SGDB PostgreSQL, Siguiente.
    * --> En Database escribimos nuestra db creada `microdb_productos_supermercado`
    ...
    * --> Ya está la conexión configurada.
    * --> IMPORTANTE : Lo único configurable es `Database: microdb_productos_supermercado` y `Contraseña:postgres`
...
* git pull https://github.com/andresWeitzel/Microdb_productos_supermercado_PostgreSQL

#### 5.5) Enviamos todos los cambios locales al repo en github
* git push https://github.com/andresWeitzel/Microdb_productos_supermercado_PostgreSQL
