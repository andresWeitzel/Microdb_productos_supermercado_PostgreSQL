...
('AET78U9', 'https://http2.mlstatic.com/D_NQ_NP_792586-MLA47682120282_092021-O.webp' ,  'Agua de Mesa sin Gas Nestlé Bidón 6.3L', 'Nestlé' ,'Bebidas', 'Agua' , 6.3 , 195.60 , 500 ),
...
-- CARNES Y PESCADOS
insert into productos(codigo, imagen , nombre, marca, tipo, grupo, peso, precio_unidad, stock) values 
('COPR8O6', 'https://d3ugyf2ht6aenh.cloudfront.net/stores/861/458/products/tapa-de-asado1-5eb3e89c1d76286a6815702030218736-480-0.jpg' ,'Tapa de Asado de Novillo x kg', 'Genérico' ,'Carnes y Pescados', 'Carne Vacuna' , 1.00 , 649.00 , 100 ),
('HJ8R2O6', 'https://t2.rg.ltmcdn.com/es/images/8/7/0/img_medallones_de_pollo_33078_orig.jpg' , 'Medallón de pollo rebozado crocante 400 g. x 4 uni', 'Genérico' ,'Carnes y Pescados', 'Pollo y Granja' , 0.400 , 369.00 , 100 ),
('KJ8R2O3', 'https://calisa.com.ar/wp-content/uploads/2020/03/pollo_con_menudos.png' ,'Pollo entero congelado x kg.', 'Genérico' ,'Carnes y Pescados', 'Pollo y Granja' , 1.00 , 174.00 , 300 ),
('JJ5R333', 'https://www.terravilena.es/wp-content/uploads/2019/11/cordero.jpg' ,'Cordero entero x kg.', 'Genérico' ,'Carnes y Pescados', 'Pollo y Granja' , 1.00 , 829.90 , 100 );
...
('KLK1832', 'https://jumboargentina.vtexassets.com/arquivos/ids/339785-1200-auto?v=636439393168030000&width=1200&height=auto&aspect=true' ,'Medallón de carne Swift receta especial reducido en grasas 4 u.', 'Swift' ,'Congelados', 'Hamburguesas' , 0.320 , 419.10 , 200 ),
...
('LL8JI10', 'https://carrefourar.vtexassets.com/arquivos/ids/204565/7794710010406_02.jpg?v=637592985140930000' ,'Leche Entera uat Larclas tetra 1L', 'Larclas' ,'Lácteos y Productos Frescos', 'Leches' , 1.00 , 70.85 , 500 ),
('HJA2234', 'https://arikiosco.tiendalite.com/images/products/500/86749394-1266.png' ,'Yogur bebible entero Sancor yogs mult. vainilla 1 l.', 'Sancor' ,'Lácteos y Productos Frescos', 'Yogures' , 1.00 , 226.80 , 300 ),
('HJA2235', 'https://tunovo.com.ar/wp-content/uploads/7790080064223_01.jpg' ,'Yogur bebible entero Sancor yogs mult. frutilla 1 l.', 'Sancor' ,'Lácteos y Productos Frescos', 'Yogures' , 1.00 , 230.80 , 300 );
...
('GHJ7711', 'https://http2.mlstatic.com/D_NQ_NP_914650-MLA31037009580_062019-O.webp' ,'Cebolla x kg', 'Genérico' ,'Frutas y Verduras', 'Verduras' , 1.00 , 48.00 , 300 ),
...
('EEE8277', 'https://elegifruta.com.ar/onepage/wp-content/uploads/2017/07/manzana_roja.jpg' ,'Manzana roja x kg.', 'Genérico' ,'Frutas y Verduras', 'Frutas' , 1.00 , 159.00 , 100 );
